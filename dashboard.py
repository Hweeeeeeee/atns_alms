...
st.markdown("""
    <style>
        ...
        /* HIGHLIGHT START: 모든 위젯에 적용될 공통 스타일 클래스 (직접 제어) */
        .widget-custom-style { /* 새로운 클래스명으로 변경 */
...
with cols_overview_row1[0]:
    # 직접 HTML div를 생성하여 스타일 적용
    st.markdown('<div class="widget-custom-style" style="height: 350px;">', unsafe_allow_html=True)
...
with cols_overview_row1[2]:
    st.markdown('<div class="widget-custom-style" style="height: 150px;">', unsafe_allow_html=True) # 1단위 높이
...
with cols_fue_row1[0]: # 1단위
    st.markdown('<div class="widget-custom-style" style="height: 150px;">', unsafe_allow_html=True)
