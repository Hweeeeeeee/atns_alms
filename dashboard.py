...
st.markdown("""
    <style>
        ...
        /* HIGHLIGHT START: 모든 위젯에 적용될 공통 스타일 - Streamlit 컨테이너의 상위 div에 직접 적용 */
        /* 이 클래스명은 Streamlit 버전업에 따라 변경될 수 있으므로 주의가 필요합니다. */
        .st-emotion-cache-ocqkzj { /* st.container(border=True)의 상위 div 클래스 */
